...
import com.dearzou.headline.adapter.FooterAdapter;

/**
 * Created by AlbertZou on 2016/12/7.
 */

public class HeadlineRecyclerView extends RecyclerView {
    ...
    public HeadlineRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HeadlineRecyclerView(Context context, AttributeSet attrs, int defStyle) {
